...
def build_generator(input_shape,
    ...
    e0 = resnet_layer(inputs=inputs0,
                           num_filters=32,
                           conv_first=True)
    ...
    e10 = resnet_layer(inputs=inputs1,
                           num_filters=32,
                           conv_first=True)
    e11 = encoder_layer(e10,
                        32,
                        strides=1,
                        kernel_size=kernel_size)
    # 256x256 x 32
    ...
    e20 = resnet_layer(inputs=inputs2,
                       num_filters=32,
                       conv_first=True)
    e21 = encoder_layer(e20,
                        32,
                        strides=1,
                        kernel_size=kernel_size)
    # 256x256 x 32
    ...
    e30 = resnet_layer(inputs=inputs3,
                       num_filters=32,
                       conv_first=True)
    e31 = encoder_layer(e30,
                        32,
                        strides=1,
                        kernel_size=kernel_size)
    # 256x256 x 32
